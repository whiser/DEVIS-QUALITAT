                                            ...
                                            <div class="panel-body">
                                                <form class="form-horizontal" method="POST" action="add.php">
                                                    ...
                                                    <div class="form-group ">
                                                        <label class="col-12 control-label">Nom du client</label>
                                                        <div class="col-12 controls">
															<input type="text" name="c_name" placeholder="Jeau du Pont">
                                                        </div>
                                                    </div>

                                                    <div class="form-group form-actions">
                                                        <div class="col-12">
                                                            <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="saveclient"><i class="icon-ok"></i> Valider</button>

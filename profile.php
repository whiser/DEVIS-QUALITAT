                            ...
                            <ul>
                                <li>
                                    <a href="acceuil.php">
                                        ...
                                        <span class="menu-badge"><span class="badge vd_bg-yellow"><i
                                    ...
                                    <div class="col-sm-3">
                                        <div class="panel widget light-widget panel-bd-top">
                                            ...
                                            <div class="panel-body">
                                                <div class="text-center vd_info-parent"> <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt=""> </div> <br>
                                                <h2 class="font-semibold mgbt-xs-5"><?= $fetch_profile['name']; ?></h2>
                                                <h4>Technicien</h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tabs widget">
                                            <div class="tab-content">
                                                <div id="profile-tab" class="tab-pane active">
                                                    <div class="pd-20">
                                                        <div class="vd_info tr"> <a href="edit_profile.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-pencil append-icon"></i> Edit </a>
                                                        </div>
                                                        <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="icon-user mgr-10 profile-icon"></i> INFORMATION</h3>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="row mgbt-xs-0">
                                                                    <label class="col-xs-5 control-label">Nom:</label>
                                                                    <div class="col-xs-7 controls"><?= $fetch_profile['name']; ?></div>
                                                                    
                                                                </div>
                                                                <div class="row mgbt-xs-0">
                                                                    <label class="col-xs-5 control-label">Email:</label>
                                                                    <div class="col-xs-7 controls"><?= $fetch_profile['email']; ?></div>

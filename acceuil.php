                    ...
                    <div class="vd_container">
                        <div class="vd_content clearfix">
                            ...
                            <div class="vd_title-section clearfix">
                                <div class="vd_panel-header">
                                    <h1>Dashboard</h1>
                                    <small class="subtitle">Devsis qualitat</small>
                            ...
                            <?php
                                                    ...
                                                    $sqlsume = $conn->prepare("SELECT COUNT(c_name)  AS Nbclient
                                                         FROM devis_client ");
                                                    $sqlsume->execute();
                                                    $Nbclient = $sqlsume->fetch(PDO::FETCH_ASSOC);
                                                    $Nbre_client_enregistre = $Nbclient['Nbclient'];

                                                    $sqlsume = $conn->prepare("SELECT COUNT(email)  AS Nbuser
                                                         FROM users ");
                                                    $sqlsume->execute();
                                                    $Nbuser = $sqlsume->fetch(PDO::FETCH_ASSOC);
                                                    $Nbre_user_enregistre = $Nbuser ['Nbuser'];
                                                    ?>
                                                ...
                                                <div class="vd_status-widget vd_bg-green widget">
                                                    ...
                                                    <a class="panel-body" href="#">
                                                        <div class="clearfix">
                                                            ...
                                                            <?php echo $Nbre_client_enregistre; ?>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="vd_status-widget vd_bg-yellow widget">
                                                    ...
                                                    <a class="panel-body" href="liste-devis.php">
                                                        <div class="clearfix">
                                                            <span class="menu-icon">
                                                                <i class="icon-users"></i>
                                                            </span>
                                                            <span class="menu-value">
                                                            <?php echo $Nbre_user_enregistre; ?>
                                                            </span>
                                                        </div>
                                                        <div class="menu-text clearfix">

                                            ...
                                            <div class="panel-body">
                                                <form class="form-horizontal" method="POST" action="add.php">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group ">
                                                            <div class="col-md-12 controls">
                                                                <input type="text" name="c_name" placeholder="Nom du client" required>
                                                            </div> <br><br>
                                                            <div class="col-md-6 controls">
                                                                <input type="text" name="email" placeholder="toto@gmail.com">
                                                            </div>
                                                            <div class="col-md-6 controls">
                                                                <input type="text" name="telephone" placeholder="+229 78675678">
                                                            </div>
                                                    ...
                                                    <div class="form-group form-actions">
                                                        <div class="col-12">
                                                            <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="saveclient"> Valider</button>

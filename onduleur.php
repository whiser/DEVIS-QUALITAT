                            ...
                            <div class="vd_content-section clearfix">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="panel widget">
                                            <div class="panel-heading vd_bg-grey">
                                                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Ajouter un Régulateur </h3>
                                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="panel widget">
                                            <div class="panel-heading vd_bg-grey">
                                                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Liiste des Régulateurs </h3>
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="menu-action">
                                                                    ...
                                                                    <a href="page/delete/delete_onduleur.php?id=<?php echo $fetch['onduleur_id'] ?>" data-original-title="delete">
                                                                        <button class="btn menu-icon vd_bd-red vd_red"><i class="fa fa-times"></i> </button>
                                                                    </a>
                                                                </td>
                                                            </tr>

...
?>
<?php
	if(ISSET($_POST['editonduleur'])){
		try{
			$onduleur_id = $_POST['onduleur_id'];
			$puissance_onduleur = $_POST['puissance_onduleur'];
			$tension_onduleur = $_POST['tension_onduleur'];
			$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			$sql = "UPDATE `onduleur`SET `onduleur_id` = '$onduleur_id', `puissance_onduleur` = '$puissance_onduleur', `tension_onduleur` = '$tension_onduleur' WHERE `onduleur_id` = '$onduleur_id'";
			$conn->exec($sql);

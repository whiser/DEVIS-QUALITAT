                  ...
                  <div class="alert alert-success vd_hidden">
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="submit" value="login now"  name="submit" id="login-submit">Login</button>
                      </div>
...
$(document).ready(function() {
        ...
        form_register_2.validate({
            ...
            submitHandler: function (form) {
				...
				setTimeout(function(){window.location.href = "acceuil.php"},2000)	 ; 				
            }
        });	
